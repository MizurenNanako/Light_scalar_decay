...
slec3 = (chisqu3 <= sig95 + chimin+0.01) & (chisqu3 >=
                                            sig95 + chimin-0.01)  # &(ma3<1900)
...
slec50 = (chisqu50 <= sig95 + chimin+0.05) & (chisqu50 >=
                                              sig95 + chimin-0.05) & (msf50 < 1650)
plt.plot(ma50[slec50], msf50[slec50], '-', color='magenta')
slec50b = (chisqu50 <= sig95 + chimin+0.025) & (chisqu50 >=
                                                sig95 + chimin-0.025) & (msf50 > 1640)
